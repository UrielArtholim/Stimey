...
<body>
    ...
    <section>
        <div id="inContrato">
            ...
            <form action="insertarAuditoria.php?usr=<?php echo $id; ?>" method="POST">
                ...
                <fieldset>
                    ...
                    <!--REVISAR EN SQL, CREO QUE FALTA--><label>Prorrata pagos</label><input type="text" name="prorrataPagos" readonly><br>
                    ...
                    <fieldset>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="baseCCTrabajador"  class="entrada-usuario" readonly></td>
                                <td><input type="text" name="porcentajeCCTrabajador"></td>
                                <td><input type="text" name="cuotaCCTrabajador"></td>
                                <td><input type="text" name="baseCCEmpresa"  class="entrada-usuario" readonly></td>
                                <td><input type="text" name="porcentajeCCEmpresa"></td>
                                <td><input type="text" name="cuotaCCEmpresa"></td>
                            </tr>
                            <tr>
                                <td>Desempleo</td>
                                <td><input type="text" name="baseDesemTrabajador"  class="entrada-usuario" readonly></td>
                                <td><input type="text" name="porcentajeDesemTrabajador"></td>
                                <td><input type="text" name="cuotaDesemTrabajador" ></td>
                                <td><input type="text" name="baseDesemEmpresa"   class="entrada-usuario" readonly></td>
                                <td><input type="text" name="porcentajeDesemEmpresa" ></td>
                                <td><input type="text" name="cuotaDesemEmpresa" ></td>
                            </tr>
                            <tr>
                                <td>I. Profesional</td>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td></td>
                                <td><input type="text" name="baseATEPEmpres"  class="entrada-usuario" readonly></td>
                                <td><input type="text" name="porcentajeATEPEmpresa"></td>
                                <td><input type="text" name="cuotaATEPEmpres"></td>
                            </tr>
                            <tr>
                                <td>Fogasa</td>
                                <td></td>
                                <td></td>
                                <td></td>
                                <td><input type="text" name="baseFogasaEmpresa"  class="entrada-usuario" readonly></td>
                                <td><input type="text" name="porcentajeFogasaEmpresa"></td>
                                <td><input type="text" name="cuotaFogasaEmpresa"></td>
                            </tr>
                            <tr>
                ...
                <fieldset>
                    ...
                    <table>
                        ...
                        <tr>
                            <td></td>
                            <td><input type="text" name="eurosRetribucion" ></td>
                            <td></td>
                            <td><input type="text" name="eurosDescuentos"></td>
                        </tr>
                    </table>
                </fieldset>
                
                <fieldset>
                    IMPORTE LÍQUIDO A RECIBIR<input type="text" name="totalCobro">
                </fieldset>
                <input type="submit" value="Insertar auditoría">
            </form>
            <!--FIN FORMULARIO AUDITORIA-->
    ...
    <a href="auditarContrato.php"><input type="button" value="Volver a auditorias"></a>
</body>
</html>