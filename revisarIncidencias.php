<?php
  ...
  $id = $_SESSION['id'];
  $tabla = "incidencias";
  $page_name = $tabla."supervisor_".$id;
  $page_ext = ".html";
  ...
  // Leer de la tabla de pruebas el id de pruebas que tengan como supervisor el id del usuario


  // Obtener las incidencias que tienen los id de pruebas obtenidos
/*
  ...
  $consulta = "Select count(*) from incidencias where test in (Select id from pruebas where supervisor = '".$id."')";
